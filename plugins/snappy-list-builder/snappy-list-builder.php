...
function slb_options_admin_page() {
    ...
    echo('<div class="wrap">
        ...
        <h2 style="margin-bottom:15px;">Snappy List Builder Options</h2>
        ...
        <form action="options.php" method="post">
            ...
            <table class="table">
                <tbody>
                    ...
                    <tr>
                        <th scope="row" style="vertical-align:top; text-align:left; width: 25%;"><label for="slb_manage_subscription_page_id">Manage Subscription Page</label></th>
                        <td>
                            '. slb_get_page_select( 'slb_manage_subscription_page_id', 'slb_manage_subsciption_page_id', 0, 'id', '') . '
                            
                            <p class="description" id="slb_manage_subscription_page_id-description" style="margin-bottom:15px;">This is the page where Snappy List 
                    ...
                    <tr>
                        <th scope="row" style="vertical-align:top; text-align:left;"><label for="slb_confirmation_page_id">Opt-In Page</label></th>
                        <td>
                            '. slb_get_page_select( 'slb_confirmation_page_id', 'slb_confirmation_page_id', 0, 'id', '') . '
                            
                            <p class="description" id="slb_confirmation_page_id-description" style="margin-bottom:15px;">This is the page where Snappy List 
                            Builder will send subscribers to confirm their subscriptions. <br/>
                    ...
                    <tr>
                        <th scope="row" style="vertical-align:top; text-align:left;"><label for="slb_reward_page_id">Download Reward Page</label></th>
                        <td>
                            '. slb_get_page_select( 'slb_reward_page_id', 'slb_reward_page_id', 0, 'id', '') . '
                            
                            <p class="description" id="slb_reward_page_id-description" style="margin-bottom:15px;">This is the page where Snappy List 
                    ...
                    <tr>
                        <th scope="row" style="vertical-align:top; text-align:left;"><label for="slb_default_email_footer">Email Footer</label></th>
                        <td>');
                        ...
                        echo('<p class="description" id="slb_default_email_footer-description" style="margin-bottom:15px;">The default text that appears
                        at the end of email generated by this plugin.</p>
                        </td>
                    </tr>

                    <tr>
                        <th scope="row" style="vertical-align:top; text-align:left;"><label for="slb_download_limit">Reward Download Limit</label></th>
                        <td>
